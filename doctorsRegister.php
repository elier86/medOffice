...
<link href="css/bootstrap.min.css" rel="stylesheet">
  ...
  <div class="py-5 text-center">
    <img class="d-block mx-auto mb-4" src="https://www.flaticon.com/svg/static/icons/svg/607/607414.svg" alt="" width="72" height="72">
    ...
    <div class="col-md-8 order-md-1">
      ...
      <form class="needs-validation" action="includes/register.inc.php" method="post">
        <div class="row">
    ...
    <div class="col-md-6 mb-3">
      ...
      <div class="col-md-6 mb-3">
        ...
        <div class="col-md-5 mb-3">
          <label for="age">Is this doctor going to have admin roles?</label>
          ...
          <button class="btn btn-success btn-lg btn-block" type="submit" name="submit">Save and Register</button>
        <p><a class="btn btn-danger btn-lg btn-block" href="doctors.php" role="button">Cancel</a></p>
