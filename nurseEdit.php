 ...
 ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Nurses:</h1>
        <img src="https://www.flaticon.com/svg/static/icons/svg/822/822111.svg" alt="nurse image" height="80px" width="80px" style="position:absolute; left:160px; top:5px;">
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
<a class="btn btn-primary" href="nurses.php" role="button"><< Go back and Cancel </a>'
          </div>
        </div>
      </div>
      <hr style="height:2px;border-width:0;color:gray;background-color:gray">
        ...
        if (isset($_POST["submit_btn"])) {
          $doctor = $_POST["pid"];
        $result = mysqli_query($conn,"SELECT * FROM nurses WHERE numEmployee = '$doctor' ");
        ...
        {
          echo '<form method="POST" action="includes/nurseEdit.inc.php">';
          echo "<tr>";
...
echo '<a class="btn btn-primary float-right" href="nurses.php" role="button"><< Go back and Cancel</a>';
echo  '</form><br><br>';
}
  ...
  if (isset($_POST["submit_btn"])) {
    $doctor = $_POST["pid"];
  $result = mysqli_query($conn,"SELECT * FROM nurses WHERE numEmployee = '$doctor' ");
  echo '<br><h1 class="h2">DISABLE NURSE:</h1>';
  echo '<hr style="width:100%;text-align:left;margin-left:0;color:gray;background-color:gray;height:5px">';
  echo '<form method="POST" action="includes/disAbleNurse.inc.php">';
  while($row = mysqli_fetch_array($result))
  {
